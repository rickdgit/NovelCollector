...
class test_sqlOperations(unittest.TestCase):
    ...
    def test_retrieveElement_multi_withCondi(self):
        ...
        testQuery = self.sqlOps.retrieveElement("user,bookID","uid","bookID = '100'")
        errorMsg = '\nError: Wrong query generated when select multiple value with condition.\n   Test query: '+testQuery+'\nCorrect query: '+query+'\n'
        self.assertEqual(testQuery,query,errorMsg)

    #book test
    def test_addBook(self):
        query = "insert into books (bkName,indexLink,totalCharNum,author) values ('testBook','www.justAtest.com','998','tester')"
    ...
    def test_deleteBook(self):
        query = "delete from books where bookID<'150'"
    ...
    def test_getBookInfosByAuthor(self):
        query = "select * from books where author = 'tester'"
        testQuery = self.sqlOps.getBookInfosByAuthor('tester')
    ...
    def test_addChars(self):
        query = "insert into CharactersTable (CharContect,CharNum,bookID,CharTitle) values ('1998','test chapter','001','065')"
    ...
    def test_getChars(self):
        ...
        testQuery = self.sqlOps.getChars("*","100","-1","50")
        errorMsg = '\nError: Wrong query generated when select single value with condition.\n   Test query: '+testQuery+'\nCorrect query: '+query+'\n'
        self.assertEqual(testQuery,query,errorMsg)
    ...
    def test_addUser(self):
        query = "insert into user (passwd,email) values ('010101','test@test.com')"
    ...
    def test_updateUserPassWd(self):
        query = "update user set passwd = '010101' where uid = '100'"
    ...
    def test_updateUserEmail(self):
        query = "update user set email = 'test@test.com' where uid = '100'"
...
#test WebPerf related
    def test_addWebsetPerf(self):
        query = "insert into websitePerf (removeTags,searchXpath,indexXPathKey,charOrder,nextCharXPathKey,encoding,POST,textXPathKey,websiteAddr,titleXPathKey) values ('teat3','test8','test6','100','test7','test2','test1','test4','test.com','test5')"
...
#TEST Task related
    def test_addTask(self):
        query = "insert into tasks (startChar,uid,bookID,endChar,bkName,currentChar,IndexLink) values ('0','001','100','50','test','10','book.com')"
        testQuery = self.sqlOps.addTask('100','001','test','book.com','10','0','50')
        errorMsg = '\nError: Wrong query generated when add a Task.\n   Test query: '+testQuery+'\nCorrect query: '+query+'\n'
        self.assertEqual(testQuery,query,errorMsg)

    def test_getTaskByTaskID(self):
        query = "select * from tasks where number = 001"
        testQuery = self.sqlOps.getTaskByTaskID('001')
        errorMsg = '\nError: Wrong query generated when select task by TaskID.\n   Test query: '+testQuery+'\nCorrect query: '+query+'\n'
        self.assertEqual(testQuery,query,errorMsg)
